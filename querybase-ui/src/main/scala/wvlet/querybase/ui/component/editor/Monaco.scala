...
package importedjs {
  ...
  package monaco {
    ...
    package editor {
      ...
      import wvlet.querybase.ui.component.editor.importedjs.monaco.editor.Editor.{
        BuiltinTheme,
    ...
    package languages {
      ...
      import wvlet.querybase.ui.component.editor.importedjs.monaco.languages.Languages.{
        IMonarchLanguageAction,
        IMonarchLanguageRule,
        ProviderResult
      }
      import wvlet.querybase.ui.component.editor.importedjs.monaco.Monaco.Thenable
      import wvlet.querybase.ui.component.editor.importedjs.monaco.languages.Languages.{
        CharacterPair,
        Definition,
        IMonarchLanguageAction,
      ...
      package typescript {
        ...
        import wvlet.querybase.ui.component.editor.importedjs.monaco.languages.typescript.Typescript.CompilerOptionsValue
